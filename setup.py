...
setup(
    ...
    version = 'v2.0.1',  # Ideally should be same as your GitHub release tag version
    ...
    download_url = 'https://github.com/bbarney213/PyLendingClub-Wrapper/archive/v2.0.1.tar.gz',
